...
/**
 * Created by ChienNV9 on 1/18/2018.
 */
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MainActivity.MESSAGE_FILE_READ, bytes,
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(MainActivity.MESSAGE_FILE_WRITTEN, -1, -1,buffer).sendToTarget();
                setState(STATE_SEND);
                setState(STATE_CONNECTED);
            } catch (IOException e) {
